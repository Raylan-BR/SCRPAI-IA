...
def Chat():
    ...
    instrucoes = "Quero que você atue como um assistente de viagens inteligente."\
                ...
                "Você deve fazer perguntas claras e objetivas caso o usuário não informe todos os dados. "\
